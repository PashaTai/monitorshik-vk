...
Автоматический мониторинг комментариев в публичных группах ВКонтакте с отправкой уведомлений в Telegram в режиме 24/7.

## 📋 Описание

MVP-решение для отслеживания новых комментариев в группах ВК, где вы **НЕ администратор**. Работает на основе polling (проверка каждые 60 секунд) и отправляет красиво отформатированные уведомления в Telegram.
...
- ✅ Поддержка различных форматов ID группы
